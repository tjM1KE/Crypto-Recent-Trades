...
async def binance_trade_stream(uri, symbol, filename):
    print(f"Connecting to {uri}")  # Debug print
    async with connect(uri) as websocket:
        print(f"Connected to {uri}")  # Debug print
        while True:
            try:
                ...
                print(f"Error in {symbol} stream: {str(e)}")  # Print the error
